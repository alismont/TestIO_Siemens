...
public int DeArd0,DeArd1;
//public int doubleA,doubleB,valueA,valueB;
//public int[] Input = {0,0};
//  To sync variable to a different device we need a ValueSender
...
void setup() 
{
  ...
  //  It shouldbe the same one that is checked under Tools->Serial Port in you Arduino IDE
  ...
  receiver.observe("VersArd0");
  receiver.observe("VersArd1");
